...
class AddButton extends StatefulWidget {
  ...
  const AddButton({super.key, 
    ...
    required this.icons, required this.onAddItem,
  });
          ...
          Material(
            ...
            child: ListTile(
              ...
              subtitle: Row(
                ...
                children: [
                  IconButton(icon: const Icon(Icons.notifications), color: _iconColor, onPressed: () {setState(() {
                    _iconColor = _iconColor == Colors.blue ? Colors.grey : Colors.blue;
                  });},),
                  IconButton(icon: const Icon(Icons.calendar_month), color: _iconColor2, onPressed: () {setState(() {
                    _iconColor2 = _iconColor2 == Colors.blue ? Colors.grey : Colors.blue;
                  });},),
                  IconButton(icon: const Icon(Icons.replay_rounded), color: _iconColor3, onPressed: () {setState(() {
                    _iconColor3 = _iconColor3 == Colors.blue ? Colors.grey : Colors.blue;
                  });},),
                ],
              ),
              leading: SizedBox(
                width: MediaQuery.of(context).size.width / 8, // Divise la largeur par 2
                height: MediaQuery.of(context).size.height, // Divise la largeur par 2
                child: NumberPicker(
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  ...
                  dbHelper.addWishesSyncro(userInput, _currentValue - 1, '2024-12-01 18:00:00', '2024-12-01 18:00:00', false, false);
